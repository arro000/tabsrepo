...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.invisiblewrench.fluttermidicommand.FlutterMidiCommandPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_midi_command, com.invisiblewrench.fluttermidicommand.FlutterMidiCommandPlugin", e);
    }
    try {
